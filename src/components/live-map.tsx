                ...
                >
                  {boxes.length === 0 ? (
                    <>
                      ...
                      <Link
                        to="/registrati"
                        className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90"
                      >
                        Aderisci come ristoratore
                      </Link>
                    </>
                  ) : (
                    <>
                      <p className="text-xs font-medium uppercase tracking-widest text-muted-foreground">
                        {userPos ? "Più vicine a te" : "Box in città"}
                      </p>
                      <h3 className="mt-1 text-2xl font-semibold text-foreground">
                        {`${available} box disponibili ora`}
                      </h3>
                      <p className="mt-3 text-sm text-muted-foreground">
                        {userPos
